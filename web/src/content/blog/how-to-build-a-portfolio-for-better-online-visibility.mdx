...
For the story behind building and finally publishing this portfolio, see [How I Finally Built My Portfolio](/writing/how-i-finally-built-my-portfolio).
...
The simplest system that makes publishing reliable is usually the better starting point. A backend, validation layer, or administration interface can be added later when the number of articles and publishing requirements justify it.
