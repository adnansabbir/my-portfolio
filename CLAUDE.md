...
**Still deferred:** RSS feed — needs actual blog content to exist first (milestone 8).
...
9. Add RSS feed once there's blog content — everything else in "SEO goals" (sitemap,
   Person schema, canonical URLs, per-page basics) is already done/baked in per step.
